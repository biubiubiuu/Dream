...
using Volo.Abp;
using static Dream.Domain.Shared.DreamDbConsts;

namespace Dream.EntityFrameworkCore
{
    public static class DreamDbContextModelCreatingExtensions
    {
        public static void Configure(this ModelBuilder builder)
        {
            ...
            {
                b.ToTable(DreamConsts.DbTablePrefix + DbTableName.Posts);
                b.HasKey(x => x.Id);
                b.Property(x => x.Title).HasMaxLength(200).IsRequired();
                b.Property(x => x.Author).HasMaxLength(10);
                b.Property(x => x.Url).HasMaxLength(100).IsRequired();
                b.Property(x => x.Html).HasMaxLength(int.MaxValue).IsRequired();
                b.Property(x => x.Markdown).HasMaxLength(int.MaxValue).IsRequired();
            ...
            {
                b.ToTable(DreamConsts.DbTablePrefix + DbTableName.Categories);
                b.HasKey(x => x.Id);
            ...
            {
                b.ToTable(DreamConsts.DbTablePrefix + DbTableName.Tags);
                b.HasKey(x => x.Id);
            ...
            {
                b.ToTable(DreamConsts.DbTablePrefix + DbTableName.PostTags);
                b.HasKey(x => x.Id);
            ...
            {
                b.ToTable(DreamConsts.DbTablePrefix + DbTableName.Friendlinks);
                b.HasKey(x => x.Id);
